...
function handleRegister(){
    ...
    if(service === "administrator"){
        ...
        window.location.href = "/skyline-drones/agriculture/index.html";
    } else {
        window.location.href = "/skyline-drones/soon.html";
    }
}
...
function handleLogin(){
    ...
    if(selected === "administrator"){
        ...
        window.location.href = "/skyline-drones/agriculture/login.html";
    } else {
        window.location.href = "/skyline-drones/soon.html";
    }
}
